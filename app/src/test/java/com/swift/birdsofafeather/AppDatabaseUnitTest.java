...
public class AppDatabaseUnitTest {
    ...
    @Test
    public void insertStudentCheckExistence() {
    ...
    @Test
    public void insertStudentInsertClassCheckExistence() {
        UUID currStudentId = UUID.randomUUID();
        ...
        Class class1 = new Class(currClassId, currStudentId, 2022, "WI", "CSE", "110", "Tiny");
